...
public class MainJFrame extends javax.swing.JFrame {
   ...
   private void initialize(EcoSystem system) {
        Initialization.createUnitedNations(system);
    }
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        if (userAccount == null) {
            //Step2: Go inside each Continent to check each Country
            for (Continent continent : system.getContinentDirectory().getContinents()) {
                //Step 2-a: Check against each Country
                if(userAccount != null) 
                    break;
                for (Country country : continent.getCountryDirectory().getCountryList()) {
                    ...
                    if (userAccount == null) {
                        ...
                        for (Department department : country.getCabinetMinistry().
                            ...
                            userAccount = department.getUserAccountDirectory().
        ...
        if (userAccount == null) {
            ...
            container.add(userAccount.getRole().toString()+"workArea", 
                    userAccount.getRole().createWorkArea(container, userAccount,
                            indepartment, inCountry, system));
